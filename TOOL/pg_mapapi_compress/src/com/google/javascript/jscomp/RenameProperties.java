...
class RenameProperties implements CompilerPass {
  ...
  private void reusePropertyNames(Set<String> reservedNames,
    ...
    for (Property prop : allProps) {
      ...
      if (!generatePseudoNames && prevName != null) {
        ...
        System.out.println("reusePropertyNames   oldName  " +(prop.oldName!=null?prop.oldName:""));
        System.out.println("reusePropertyNames   newName  " +(prop.newName!=null?prop.newName:""));
  ...
  private void generateNames(Set<Property> props, Set<String> reservedNames) {
    ...
    for (Property p : props) {
      ...
      System.out.print("generateNames   oldName  " +(p.oldName!=null?p.oldName:""));
      System.out.println("     newName  " +(p.newName!=null?p.newName:""));
  ...
  private class Property {
    ...
    Property(String name) {
      this.oldName = name;
     // System.out.println("Property   oldName  " +(oldName!=null?oldName:""));
     // System.out.println("Property   newName  " +(newName!=null?newName:""));
    }
  }
