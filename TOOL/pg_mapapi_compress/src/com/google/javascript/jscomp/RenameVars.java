...
final class RenameVars implements CompilerPass {
  ...
  class Assignment {
    ...
    void setNewName(String newName) {
     ...
     // System.out.print("setNewName   oldName  " +(this.oldName!=null?this.oldName:""));
     // System.out.println("     newName  " +(this.newName!=null?this.newName:""));
    }
  }
  ...
  private String getNewGlobalName(Node n) {
    ...
    if (a.newName != null && !a.newName.equals(oldName)) {
     ...
     // System.out.print("getNewGlobalName   oldName  " +(a.oldName!=null?a.oldName:""));
     // System.out.println("  newName  " +(a.newName!=null?a.newName:""));
      return a.newName;
    } else {
      return null;
    }
  ...
  private String getNewLocalName(Node n) {
    ...
    if (!a.newName.equals(oldTempName)) {
     ...
     // System.out.print("getNewLocalName   oldName  " +(a.oldName!=null?a.oldName:""));
     // System.out.println("   newName  " +(a.newName!=null?a.newName:""));
      return a.newName;
  ...
  private void assignNames(Set<Assignment> varsToRename) {
    ...
    for (Assignment a : varsToRename) {
      ...
      System.out.print("assignNames   oldName  " +(a.oldName!=null?a.oldName:""));
      System.out.println("  newName  " +(a.newName!=null?a.newName:""));
