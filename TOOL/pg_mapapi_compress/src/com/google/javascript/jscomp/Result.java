...
public class Result {
  ...
  //  System.out.println("Result   variableMap  " +variableMap.getOriginalNameToNewNameMap());
  //  System.out.println("Result   variableMap  " +variableMap.getNewNameToOriginalNameMap());
    
 //   System.out.println("Result   propertyMap  " +propertyMap.getOriginalNameToNewNameMap());
  //  System.out.println("Result   propertyMap  " +propertyMap.getNewNameToOriginalNameMap());
   //System.out.println("Result   propertyMap  " +propertyMap);
    
   // System.out.println("Result   stringMap  " +(stringMap!=null?stringMap:""));
    
    
   // System.out.println("Result   namedAnonFunctionMap  " +(namedAnonFunctionMap!=null?namedAnonFunctionMap:""));
    
   // System.out.println("Result   sourceMap  " +(sourceMap!=null?sourceMap:""));

   // System.out.println("Result   cssNames  " +(cssNames!=null?cssNames:""));

   // System.out.println("Result   idGeneratorMap  " +(idGeneratorMap!=null?idGeneratorMap:""));
