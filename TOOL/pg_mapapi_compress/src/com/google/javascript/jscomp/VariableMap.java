...
public class VariableMap {
  ...
  // System.out.println("Result 2222  variableMap  " +map);
  }
  ...
  public static VariableMap load(String filename) throws IOException {
    try {
    	VariableMap m = fromBytes(Files.toByteArray(new File(filename)));
    	 System.out.println("Result 3333  filename  " +filename);
    	 System.out.println("Result 3333  variableMap  " +m.map);
      return m;
  ...
  public static VariableMap fromBytes(byte[] bytes) throws ParseException {
    ...
    //  System.out.println("VariableMap  " +line.substring(0, pos)+"   "+line.substring(pos + 1));
    }
