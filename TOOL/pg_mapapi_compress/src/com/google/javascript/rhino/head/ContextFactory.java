...
public class ContextFactory
{
    ...
    /**
     * Provides a default
     * {@link com.google.javascript.rhino.head.xml.XMLLib.Factory XMLLib.Factory}
     ...
     */
    protected com.google.javascript.rhino.head.xml.XMLLib.Factory
        getE4xImplementationFactory()
    {
        ...
        if (isDom3Present()) {
            return com.google.javascript.rhino.head.xml.XMLLib.Factory.create(
                "com.google.javascript.rhino.head.xmlimpl.XMLLibImpl"
            );
        } else if (Kit.classOrNull("org.apache.xmlbeans.XmlCursor") != null) {
            return com.google.javascript.rhino.head.xml.XMLLib.Factory.create(
                "com.google.javascript.rhino.head.xml.impl.xmlbeans.XMLLibImpl"
            );
        } else {
            return null;
        }
