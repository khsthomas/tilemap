...
/**
 * Exception thrown by 
 * {@link com.google.javascript.rhino.head.Context#executeScriptWithContinuations(Script, Scriptable)}
 * and {@link com.google.javascript.rhino.head.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
 * when execution encounters a continuation captured by
 * {@link com.google.javascript.rhino.head.Context#captureContinuation()}.
 * Exception will contain the captured state needed to restart the continuation
 * with {@link com.google.javascript.rhino.head.Context#resumeContinuation(Object, Scriptable, Object)}.
 * @author Norris Boyd
 */
public class ContinuationPending extends RuntimeException {
     ...
     * calling {@link com.google.javascript.rhino.head.Context#executeScriptWithContinuations(Script, Scriptable)}
     * and {@link com.google.javascript.rhino.head.Context#callFunctionWithContinuations(Callable, Scriptable, Object[])}
     ...
     * {@link com.google.javascript.rhino.head.Context#resumeContinuation(Object, Scriptable, Object)}.
