...
public class Delegator implements Function {
     ...
     *
     * @see com.google.javascript.rhino.head.Delegator#construct
     */
    public Delegator() {
    }
    ...
    /**
     * @see com.google.javascript.rhino.head.Scriptable#getClassName
     */
    public String getClassName() {
        return obj.getClassName();
    }
    /**
     * @see com.google.javascript.rhino.head.Scriptable#get(String, Scriptable)
     */
    public Object get(String name, Scriptable start) {
        return obj.get(name,start);
    }
    /**
     * @see com.google.javascript.rhino.head.Scriptable#get(int, Scriptable)
     */
    ...
    /**
     * @see com.google.javascript.rhino.head.Scriptable#has(int, Scriptable)
     */
    ...
    /**
     * @see com.google.javascript.rhino.head.Scriptable#put(int, Scriptable, Object)
     */
    public void put(int index, Scriptable start, Object value) {
        obj.put(index,start,value);
    }
    /**
     * @see com.google.javascript.rhino.head.Scriptable#delete(String)
     */
    public void delete(String name) {
        obj.delete(name);
    }
    /**
     * @see com.google.javascript.rhino.head.Scriptable#delete(int)
     */
    public void delete(int index) {
        obj.delete(index);
    }
    /**
     * @see com.google.javascript.rhino.head.Scriptable#getPrototype
     */
    public Scriptable getPrototype() {
        return obj.getPrototype();
    }
    /**
     * @see com.google.javascript.rhino.head.Scriptable#setPrototype
     */
    public void setPrototype(Scriptable prototype) {
        obj.setPrototype(prototype);
    }
    /**
     * @see com.google.javascript.rhino.head.Scriptable#getParentScope
     */
    public Scriptable getParentScope() {
        return obj.getParentScope();
    }
    /**
     * @see com.google.javascript.rhino.head.Scriptable#setParentScope
     */
    public void setParentScope(Scriptable parent) {
        obj.setParentScope(parent);
    }
    /**
     * @see com.google.javascript.rhino.head.Scriptable#getIds
     */
     ...
     *
     * @see com.google.javascript.rhino.head.Scriptable#getDefaultValue
     */
    ...
    /**
     * @see com.google.javascript.rhino.head.Scriptable#hasInstance
     */
    public boolean hasInstance(Scriptable instance) {
        return obj.hasInstance(instance);
    }
    /**
     * @see com.google.javascript.rhino.head.Function#call
     */
